...
import { Calendar, Tag, ArrowLeft, Share2, Copy } from 'lucide-react';
          ...
          {news.images && news.images.length > 0 && (
            <div className="w-full flex justify-center mb-4 overflow-hidden" style={{ borderRadius: '0 0 1.5rem 1.5rem' }}>
              <img
                src={news.images[0]}
                alt="news-img"
                className={`w-full max-h-[80vh] object-contain transition-transform duration-300 ${isImageZoomed ? 'scale-150 cursor-zoom-out' : 'scale-100 cursor-zoom-in'
                  }`}
